...
const Footer = () => {
    return (
        <div className="rounded-div mt-8 pt-8 text-primary">
            <div className="grid md:grid-cols-2">
                <div className="flex justify-evenly w-full md:max-w-[300px] uppercase">
                    ...
                    <div>
                        ...
                        <ul>
                            <li className="text-sm py-2">Adobe Us</li>
                        ...
                        <div className="w-full md:w-[300px] py-4 relative">
                            ...
                            <div className="py-4">
                                <form>
                                    ...
                                    <button className="bg-button text-btnText px-4 p-2 w-full rounded-2xl shadow-xl hover:shadow-2xl md:w-auto my-2">Sing up</button>
                                </form>
                            </div>

                            <div className="flex py-4 justify-between text-center">
                                <AiOutlineInstagram />
                                <FaTiktok />
                                <FaTwitter />
                                <FaFacebookF />
            ...
            <p className="text-center py-4">Powerd by Coin Geko</p>
        </div>
    );
};
